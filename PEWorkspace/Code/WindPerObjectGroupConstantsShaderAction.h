#ifndef __PYENGINE_2_0_WindPerObjectGroupConstants_SHADER_ACTION_H__
#define __PYENGINE_2_0_WindPerObjectGroupConstants_SHADER_ACTION_H__
...
namespace PE {
	...
	struct WindPerObjectGroupConstantsShaderAction : ShaderAction
	{
		WindPerObjectGroupConstantsShaderAction(PE::GameContext& context, PE::MemoryArena arena)
		{
