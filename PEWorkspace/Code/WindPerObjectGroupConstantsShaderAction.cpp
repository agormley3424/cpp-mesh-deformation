...
namespace PE {
	...
	void WindPerObjectGroupConstantsShaderAction::bindToPipeline(Effect* pCurEffect /* = NULL*/)
	{
		...
		pDevice->SetVertexShaderConstantF(163, (const float*)(&m_data), 12);
		pDevice->SetPixelShaderConstantF(163, (const float*)(&m_data), 12);
	...
	void WindPerObjectGroupConstantsShaderAction::unbindFromPipeline(Components::Effect* pCurEffect/* = NULL*/)
	{}

	void WindPerObjectGroupConstantsShaderAction::releaseData()
	{}


#if APIABSTRACTION_OGL
	void WindPerObjectGroupConstantsShaderAction::PerEffectBindIds::initialize(Effect* pEffect)
	{
#if APIABSTRACTION_IOS 
	...
	void WindPerObjectGroupConstantsShaderAction::PerEffectBindIds::initializeLightCGParams(unsigned int index, LightCGParams& out_v, LightCGParams& out_f, Effect* pEffect)
	{
#if APIABSTRACTION_IOS
		char index_num[8];
